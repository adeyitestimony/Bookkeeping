...
$result = mysqli_query(
    $db_connect,
    "SELECT * FROM income WHERE id='$id' AND user_id='$user_id'"
);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    mysqli_query(
        $db_connect,
        "UPDATE income
         SET recipientname='$recipientname', service= '$service', amount='$amount', time='$time' 
...
<div id="container">
<form method="POST">
<input type="text" class="text" name="recipientname" value="<?= htmlspecialchars($row['recipientname']) ?>" required>
